...
#
# Attoya Database ORM Class
#
class AttoyaDatabaseOrm {
  ...
  # @param AttoyaModel $model_instance
  #
  public static function store($model_instance = null) {

    if (is_subclass_of($model_instance) !== 'AttoyaModel') {
      self::throw_exception('->store() Model Instance is not a AttoyaModel');
    }
  ...
  public static function archive($model_instance = null) {
    ...
    if (is_subclass_of($model_instance) !== 'AttoyaModel') {
      self::throw_exception('->archive() Model Instance is not a AttoyaModel');
    }
  ...
  public static function discard($model_instance = null) {
    ...
    if (is_subclass_of($model_instance) !== 'AttoyaModel') {
      self::throw_exception('->discard() Model Instance is not a AttoyaModel');
    }
  ...
  public static function delete($model_instance = null) {
    ...
    if (is_subclass_of($model_instance) !== 'AttoyaModel') {
      self::throw_exception('->delete() Model Instance is not a AttoyaModel');
    }
  ...
  public static function throw_exception($message) {
    ...
    include_once VENDOR_ROOT . '/attoya/exception/AttoyaDatabaseOrmException.php';

    $message = get_called_class(self) . print_r($message, true);

    throw new AttoyaDatabaseOrmException($message);
